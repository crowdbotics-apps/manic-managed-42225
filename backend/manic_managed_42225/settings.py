"""
Django settings for manic_managed_42225 project.
...
ROOT_URLCONF = 'manic_managed_42225.urls'
...
WSGI_APPLICATION = 'manic_managed_42225.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "manic_managed_42225 API",
    "DESCRIPTION": "API documentation for manic_managed_42225 App",
    "VERSION": "v1",
}
